...
{{{marginfig(ringbuffer.jpg, **Ring buffer**. a buffer with 32 slots. The producer has filled 15 of them, indicated by blue. The consumer is behind the producer, reading data from the slots, freeing them as it does so. A free slot is indicated by orange.)}}}
