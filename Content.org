...
* TODO [#B] Self-Hosting on the Dark Web
:PROPERTIES:
...
connection is end-to-end encrypted by Tor itself.]  [[https://www.torproject.org/][Tor]] routes your
...
It's built by the nonprofit [[https://www.torproject.org/][Tor Project]] to help people resist tracking,
surveillance, and censorship.  The network only works because people use
it, so consider [[https://donate.torproject.org/][supporting them]] or running a relay---your contribution
...
* TODO [#B] Laissez faire, laisaez mourir                           :backlog:
