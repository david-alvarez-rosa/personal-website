...
forwarded it to any machine at home.[fn::A dynamic DNS service kept your
...
~PostUp~ sets up firewall rules at the kernel level.[fn::And ~PostDown~
removes them when the tunnel goes down.]  The first two exclude ports
...
router.[fn::From then on, SSH to ~ssh.alvarezrosa.com~ at ports 22 lands
