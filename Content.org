...
deterministic.[fn::Note that tuning for /benchmarking/ is not the same
as tuning for /performance:/ a benchmark wants the machine repeatable,
...
:EXPORT_HUGO_SECTION: .
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :seotitle "David Álvarez Rosa | Personal Site"
:END:
