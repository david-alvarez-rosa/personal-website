...
* TODO [#B] Valgrind                                                :backlog:

* TODO [#B] Heaptrack tool                                          :backlog:

* TODO [#B] Emacs config and/or Arch Linux config                   :backlog:

* TODO [#B] Optimizing an Order Book                                :backlog:
https://github.com/atribout

* TODO [#B] Perf improvements website                               :backlog:
- CDN
...
* TODO [#B] QUIC protocol                                           :backlog:

* TODO [#B] Building a Mouse Jiggler                                :backlog:
:PROPERTIES:
:EXPORT_FILE_NAME: building-a-mouse-jiggler
:END:
...
* TODO [#B] Minimalist Invoice                                      :backlog:

* TODO [#B] Laissez Faire, Laissez Mourir                           :backlog:
:PROPERTIES:
...
Jeff Yass, owner of Susquehanna ($65 billion),[fn::[[https://www.forbes.com/profile/jeff-yass/][Forbes profile]],
December 2025.] paid the 20% long-term rate on trading income ordinarily
taxed near 40%---roughly $1 billion saved, disputed in
court.[fn::ProPublica, [[https://www.propublica.org/article/how-susquehanna-yass-avoided-billion-taxes][/How Susquehanna's Jeff Yass Avoided $1 Billion
in Taxes/]], 2022.  The Tax Court dispute was filed in 2020 and remains
pending.]  Susquehanna also owns some 15% of ByteDance, TikTok's
parent;[fn::[[https://www.inquirer.com/politics/pennsylvania/tiktok-ban-jeff-yass-congress-house-20240313.html]["A ban on TikTok would be a blow to local billionaire
investor and GOP megadonor Jeff Yass,"]] /The Philadelphia Inquirer/,
March 13, 2024; [[https://abcnews.go.com/Politics/trumps-tiktok-ban-reversal-after-meeting-megadonor-stake/story?id=108013785][ABC News]], March 2024.] Yass put $100 million into the
...
[[https://www.theguardian.com/us-news/2024/apr/24/jeff-yass-anti-muslim-pro-israel-donations]["Billionaire Jeff Yass linked to $16m in donations to anti-Muslim and
pro-Israel groups,"]] /The Guardian/, April 24, 2024.]---and days after
...
* TODO [#B] Self-Hosting an Email Server                            :backlog:
:PROPERTIES:
:EXPORT_FILE_NAME: self-hosting-an-email-server
:END:
...
* TODO [#B] Self-Hosting Behind CGNAT                               :backlog:
:PROPERTIES:
...
:PROPERTIES:
:EXPORT_FILE_NAME: incremental-clang-tidy-tool
:END:
...
* TODO [#B] Optimizing a Spin-Lock                          :cpp:performance:
:PROPERTIES:
:EXPORT_FILE_NAME: optimizing-a-spin-lock
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :subtitle "Squeezing every pico out of the simplest lock."
:END:
:LOGBOOK:
CLOCK: [2026-08-08 Sat 12:25]
...
pinned.[fn::Run on a box [[/posts/tuning-a-server-for-benchmarking/][tuned for benchmarking]] (AMD Ryzen 7 PRO 8700GE,
...
One thread to two triples the time.  Two to four barely moves.[fn::A
...
An atomic bool and an exchange loop.[fn::~exchange~ atomically writes
...
It wins at one thread.[fn::Locking is now one atomic instruction, with
no library code around it.]  At two threads it is 1.7x slower.  At four
...
ten branches is mispredicted.[fn::Whether the exchange succeeds is
...
Spinning costs energy too.[fn::High-frequency trading shops watch this
number.  [[https://www.nyse.com/technology/colo][Exchange colocation services]] bill power, and NYSE [[https://www.federalregister.gov/documents/2023/11/20/2023-25548/self-regulatory-organizations-new-york-stock-exchange-llc-nyse-american-llc-nysearca-inc-nyse][caps]] at 32
kW.]
At four threads it draws *49.23 J* against the baseline's 32.98 J for
the same work.[fn::Reading the RAPL counters requires system-wide
...
out.[fn::~volatile~ keeps the compiler from deleting the empty loop.  The
...
the same work.[fn::The delay loop also floods the branch counter with
...
equivalent is the ~yield~ instruction.]  It marks the loop as a
...
Let each thread double its delay instead, up to a cap.[fn::Without the
...
Feel free to reproduce yourself using the [[https://github.com/david-alvarez-rosa/CppPlayground/blob/main/dsa/spin_lock.cpp][benchmark]].
...
dedicated cores,[fn::The standard library cannot assume that.  A
spin-lock waits for a holder the scheduler may have descheduled, so
~std::mutex~ parks the waiters and hands the core back instead.] and you
have measured the difference.

* DONE [#B] One Hundred Thousand Reads
CLOSED: [2026-07-16 Thu 11:00]
:PROPERTIES:
:EXPORT_FILE_NAME: one-hundred-thousand-reads
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :subtitle "A thank you, and a look at the numbers."
:END:
:LOGBOOK:
CLOCK: [2026-07-18 Sat 11:00]--[2026-07-18 Sat 11:00] =>  0:00
:END:
...
over 41,000 reads to a few such days.[fn::[[/posts/optimizing-a-lock-free-ring-buffer/][Optimizing a Lock-Free Ring
Buffer]] leads with 17,169 reads, followed by the [[/posts/fundamental-theorem-of-calculus/][Fundamental Theorem of
Calculus]] (12,575) and [[/posts/devirtualization-and-static-polymorphism/][Devirtualization and Static Polymorphism]]
(11,961).]

Thank you, again, for reading.

* DONE [#B] Tuning a Server for Benchmarking                    :performance:
CLOSED: [2026-06-25 Thu 18:02]
:PROPERTIES:
:EXPORT_FILE_NAME: tuning-a-server-for-benchmarking
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :subtitle "Taming OS and hardware noise for repeatable benchmarks."
:END:
...
change, until runs become deterministic.[fn::Note that tuning for
...
between bursts.[fn::Pinning puts the benchmark /onto/ the core but does
...
numbers, and those are now comparable across runs.[fn::Low-latency
...
percent are now real, measurable signal.[fn::Feel free to reproduce on
your machine using the [[https://github.com/david-alvarez-rosa/CppPlayground/blob/main/scratch/benchmark.cpp][benchmark]] from my [[https://github.com/david-alvarez-rosa/CppPlayground][CppPlayground]] repository.]
...
transparent huge pages.  The [[https://github.com/david-alvarez-rosa/CppPlayground/blob/main/scripts/bench-remote.sh][bench-remote.sh]] script applies all.  None
...
* DONE [#B] Self-Hosting on the Dark Web                       :self_hosting:
CLOSED: [2026-06-01 Mon 10:55]
:PROPERTIES:
:EXPORT_FILE_NAME: self-hosting-on-the-dark-web
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :subtitle "Bringing this site to Tor as a hidden service."
:END:
...
* DONE [#B] First Steps on a New Server                        :self_hosting:
CLOSED: [2026-05-17 Sun 17:26]
:PROPERTIES:
:EXPORT_FILE_NAME: first-steps-on-a-new-server
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :subtitle "A personal checklist for settling into a fresh machine."
:END:
...
* DONE [#B] Fundamental Theorem of Calculus                     :mathematics:
CLOSED: [2026-04-22 Wed 20:14]
:PROPERTIES:
:EXPORT_FILE_NAME: fundamental-theorem-of-calculus
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :latex true :subtitle "From the Riemann integral to the keystone of calculus."
:END:
...
* DONE [#B] Optimizing a Lock-Free Ring Buffer              :cpp:performance:
CLOSED: [2026-03-24 Tue 11:51]
:PROPERTIES:
:EXPORT_FILE_NAME: optimizing-a-lock-free-ring-buffer
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :subtitle "Building a lock-free SPSC queue for the lowest latency."
:END:
:LOGBOOK:
...
** What is a ring buffer?
 ...
 [fn::[[./assets/images/ringbuffer.jpg]] *Ring buffer with 32 slots.* The
...
does so.  A free slot is indicated by orange.]You might have run into
the term circular buffer, or perhaps cyclic queue.  These are simply
other names for a /ring buffer:/ a queue where a producer generates data
...
array[fn::By using ~std::array~ we are forcing clients to define the
...
masking ~head & (N - 1)~ instead of a branch.] and two indices.  We
...
We can now implement the ~push~ (or write) operation[fn::Note how one
...
Next we implement the ~pop~ (or read) operation[fn::Again note that
...
It's correct and often fast enough: around *12M ops/s*[fn::Compiled with
~clang~ compiler with highest ~-O3~ optimization level, and
~-march=native -ffast-math~.  Consumer and producer threads are pinned
to dedicated cores (Intel Core Ultra 5 135U).  See [[https://github.com/david-alvarez-rosa/CppPlayground/blob/main/dsa/ring_buffer.cpp][benchmark]].] on
...
We can remove the locks by using atomics instead[fn::Note that we are
...
memory order[fn::~release~ ensures prior writes are visible to threads
...
other's indexes.  That makes the CPU bounce cache lines[fn::It's useful
to observe the number of cache misses with ~perf stat -e cache-misses~;
they are greatly reduced in this approach.] between cores, which is
expensive.

To reduce this, the reader can keep a local cached copy[fn::This
advanced optimization was inspired by [[https://rigtorp.se][Erik Rigtorp]].  For an earlier
...
(IPDPS)/---[[https://doi.org/10.1109/IPDPS.2010.5470368][doi:10.1109/IPDPS.2010.5470368]] ([[https://www.cse.cuhk.edu.hk/~pclee/www/pubs/ipdps10.pdf][PDF]]).] of the write index,
...
compiled with at least ~-O3~ optimization level.[fn::Alongside ~-O3~,
the benchmark was compiled with ~-march=native~ and ~-ffast-math~,
though these flags shouldn't make a difference here.] The benchmark pins
...
* DONE [#B] Deriving Type Erasure                                       :cpp:
CLOSED: [2026-03-10 Tue 09:46]
:PROPERTIES:
:EXPORT_FILE_NAME: deriving-type-erasure
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :subtitle "Building a minimal std::any to demystify type erasure."
:END:
:LOGBOOK:
...
method.  We start with an interface[fn::Remember that interfaces that
are intended to be used through a ~Base&~ or ~Base*~ must have a virtual
destructor, to ensure derived classes are properly destructed [[https://isocpp.github.io/CppCoreGuidelines/CppCoreGuidelines#c127-a-class-with-a-virtual-function-should-have-a-virtual-or-protected-destructor][(C.127)]].]
class
...
cannot share a common base class.[fn::In some cases, you may not have
...
(e.g. builtins like ~int~).] In that case, if the types provide the same
...
code would compile[fn::If you tried to pass in a type that doesn't
...
~std::string~ doesn't have an ~area~ method.] for the given type.
...
The *second* drawback[fn::Since you're employing polymorphism in the
...
templates[fn::This implementation always heap-allocates.  Production
...
is the type-erasure /concept/[fn::The type erasure concept is an
OO-style interface (a vtable).  It's unrelated to C++20 ~concept~
(compile-time predicates).] (the interface we program against), and the
latter is the /model/ (a templated wrapper that implements the interface
...
~std::any~,[fn::For a Rust version, see Waifod's post [[https://waifod.dev/blog/polymorphism-type-erasure/][Polymorphism in
C++ and Rust: Type Erasure]].] which is even used in the STL itself
(namely, in ~std::function~).  But that's for another post.

* DONE [#B] Devirtualization and Static Polymorphism        :cpp:performance:
CLOSED: [2026-02-25 Wed 09:45]
:PROPERTIES:
:EXPORT_FILE_NAME: devirtualization-and-static-polymorphism
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :subtitle "The hidden cost of virtual dispatch, and how to escape it."
:END:
:LOGBOOK:
...
assembly[fn::Assembly generated with ~gcc~ at ~-O3~ on x86-64.  Similar
results were observed with ~clang~ on the same platform.] code emitted
...
devirtualization is straightforward[fn::The compiler emits a direct call
to ~Derived::foo~ (or inlines it), because ~derived~ cannot have any
other dynamic type.] when the runtime type is clearly fixed
...
Recurring Template Pattern[fn::The curiously recurring template pattern
...
F-bound polymorphism, a form of F-bounded quantification.] (CRTP).  With
...
Fully optimized[fn::The trade-off is that each ~Base<Derived>~
...
across different derived types must itself be templated.] call.
...
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :subtitle "Rebuilding a personal blog from scratch, a decade on."
:END:
:LOGBOOK:
CLOCK: [2026-01-24 Sat 10:47]--[2026-01-24 Sat 10:47] =>  0:00
:END:
...
writing things down.[fn::As Einstein put it, /"If you can't explain it
simply, you don't understand it well enough."/ Feynman followed the same
...
theme.[fn::Inspired by the work of Edward Tufte and Matthew Butterick.]
...
:PROPERTIES:
:EXPORT_TITLE: David Álvarez Rosa
:EXPORT_FILE_NAME: about
:EXPORT_HUGO_SECTION: .
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :subtitle Curriculum Vitae :seotitle "About | David Álvarez Rosa"
:END:
...
#+end_export
 ...
 [fn::[[./assets/images/portrait.png]] *That's me!* March
2022.]Mathematician and engineer based in sunny Dublin, passionate about
...
[fn::Jul 2024--Present@@html:<span class="sep"></span>@@Dublin, Ireland]\\
...
[fn::Mar 2022--Aug 2024@@html:<span class="sep"></span>@@Madrid, Spain]\\
...
[fn::Apr 2024--Jul 2024@@html:<span class="sep"></span>@@Remote]\\
Researched, designed, and built a semantic cache for LLMs.

/Risk Analyst @ Deloitte/
[fn::Sep 2021--Mar 2022@@html:<span class="sep"></span>@@Madrid, Spain]\\
...
[fn::Sep 2020--Jun 2021@@html:<span class="sep"></span>@@Toronto, Canada]\\
Research thesis on multimodal learning (recomprehension.com).

/Machine Learning Engineer @ BCN eMotorsport/
[fn::Sep 2019--Feb 2020@@html:<span class="sep"></span>@@Barcelona, Spain]\\
...
[fn::GPA 9.00/10@@html:<span class="sep"></span>@@Honors in 6 subjects]\\
...
/BSc in Mathematics/
[fn::GPA 8.12/10 (top 10%)@@html:<span class="sep"></span>@@Honors in 9 subjects]\\
Rigorous and proof-oriented degree with a robust mathematical base.

/BEng in Industrial Engineering/
[fn::GPA 8.03/10 (top 2%)@@html:<span class="sep"></span>@@Honors in 14 subjects]\\
...
:EXPORT_HUGO_SECTION: .
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :subtitle "Mathematician · Engineer · Dublin" :seotitle "David Álvarez Rosa | Personal Site"
:END:

 [fn::[[./assets/images/home-illustration.png]] ‎]Hi! This is my personal
site, where I share notes on software and self-hosting.  You'll learn
how things work under the hood, and how to make them run fast, /very/
fast.
...
* DONE [#B] Posts
CLOSED: [2026-06-26 Fri 22:24]
:PROPERTIES:
:EXPORT_FILE_NAME: _index
:EXPORT_HUGO_SECTION: posts
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :subtitle "Essays on software, performance, and self-hosting."
:END:
...
:EXPORT_HUGO_SECTION: .
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :notice true :noindex true :sitemap '(:disable true) :build '(:list "never")
:END:
...
* DONE [#B] Subscription Pending
:PROPERTIES:
:EXPORT_FILE_NAME: subscription-pending
:EXPORT_HUGO_SECTION: .
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :notice true :noindex true :sitemap '(:disable true) :build '(:list "never")
:END:
...
Changed your mind?  You can [[/#subscribe][subscribe again]] anytime.
