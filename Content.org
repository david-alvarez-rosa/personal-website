...
* TODO [#B] Emacs config and/or Arch Linux config

* TODO [#B] Optimizing and Order Book
...
Thank you, again, for reading.  [[/#subscribe][Subscribe]] or follow by [[/index.xml][RSS]], and feedback
is always welcome---[[/about/#contact][get in touch]].
...
:EXPORT_HUGO_SECTION: .
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :subtitle Curriculum Vitae :seotitle "About | David Álvarez Rosa | Personal Site"
:END:
