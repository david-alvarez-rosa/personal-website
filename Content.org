...
* TODO [#B] Reflecting on One Hundred Thousand Reads                   :meta:
:PROPERTIES:
:EXPORT_FILE_NAME: reflecting-on-one-hundred-thousand-reads
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :subtitle "A thank-you, and where the reads come from."
:END:
...
steady interest.[fn::[[/posts/optimizing-a-lock-free-ring-buffer/][Optimizing a Lock-Free Ring Buffer]] leads with
16,635 reads, followed by the [[/posts/fundamental-theorem-of-calculus/][Fundamental Theorem of Calculus]] (12,506)
and [[/posts/devirtualization-and-static-polymorphism/][Devirtualization and Static Polymorphism]] (11,848).] Search is the
