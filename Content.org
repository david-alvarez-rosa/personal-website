...
#+caption: *My homelab server* (AMD Ryzen 7 PRO 8700GE).  Eight identical cores with identical caches; the NVMe drives and the NIC hang off the PCI bus on the right.
