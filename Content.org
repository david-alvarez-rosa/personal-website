...
one branch in nine is mispredicted.[fn::Whether the exchange succeeds is
...
~_mm_pause~, marks the loop as a spin-wait, so the core idles.[fn::The
...
round, doubling up to a cap.[fn:: Example 2-10, /Contended Locks with
Increasing Back-off/, in the [[https://cdrdv2.intel.com/v1/dl/getContent/671488][Intel Optimization Reference Manual]] (PDF,
