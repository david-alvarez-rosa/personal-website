...
* DONE [#B] Optimizing a Lock-Free Ring Buffer  :performance:
...
* DONE [#B] Devirtualization and Static Polymorphism  :cpp:
...
:EXPORT_HUGO_SECTION: .
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :subtitle " " :notice true :noindex true :sitemap '(:disable true) :build '(:list "never")
:END:
