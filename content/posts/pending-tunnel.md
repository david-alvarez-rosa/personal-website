...
PostUp = iptables -t nat -A PREROUTING -i ens3 -p tcp --dport 2222 -j RETURN
...
PostUp = iptables -A FORWARD -i ens3 -o wg0 -d 10.0.0.2 -j ACCEPT
PostDown = iptables -t nat -D PREROUTING -i ens3 -p udp --dport 51820 -j RETURN
PostDown = iptables -t nat -D PREROUTING -i ens3 -p tcp --dport 2222 -j RETURN
...
PostDown = iptables -D FORWARD -i ens3 -o wg0 -d 10.0.0.2 -j ACCEPT
...
PostDown = ip route del default dev wg0 table 200A
